...
sdk_generator_api.genConfiguration.extend(["sampleApps_ble.json"])
...
def createSampleApp(studioContext):
  """Call creator and return creation result.
     Before running the creator python/jython major and minor version are
     checked for compatibility. Configuration data is sanity checked too.

  Returns:
      Result of generation.
  """
  return sdk_generator_api.createSampleApp(studioContext)
